...
{
    private static readonly KeybindList menuHotkey1 = new(new Keybind(SButton.LeftControl, SButton.LeftShift, SButton.Divide));
    private static readonly KeybindList menuHotkey2 = new(new Keybind(SButton.LeftControl, SButton.LeftShift, SButton.Multiply));
    ...
    private void Input_ButtonsChanged(object? sender, ButtonsChangedEventArgs e)
    {
        ...
        {
            var materialItems = PurchasableItem.LoadAll(["(O)330", "(O)382", "(O)380", "(O)388", "(O)390", "(O)709"], 0.25f);
