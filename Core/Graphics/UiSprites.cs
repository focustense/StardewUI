...
public static class UiSprites
{
    ...
    public static Sprite MenuSlotInset =>
        new(Game1.menuTexture, SourceRect: new(0, 320, 60, 60), FixedEdges: new(4, 10, 8, 4));
    ...
    public static Sprite MenuSlotInsetUncolored =>
        new(Game1.uncoloredMenuTexture, SourceRect: new(0, 320, 60, 60), FixedEdges: new(4, 10, 8, 4));
