...
public interface IObjectDescriptor
{
    ...
    /// </summary>
    /// <param name="name">The property name.</param>
    /// <param name="property">When this method returns, holds a reference to the <see cref="IPropertyDescriptor"/> whose
    /// <see cref="IPropertyDescriptor.Name"/> is <paramref name="name"/>, or <c>null</c> if no property was found with the
    /// given name.</param>
