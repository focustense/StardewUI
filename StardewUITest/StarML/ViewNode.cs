...
public class ViewNode(IViewFactory viewFactory, IViewBinder viewBinder, SElement element, IEnumerable<IViewNode> childNodes) : IViewNode
{
    ...
    static class ReflectionChildrenBinder
    {
        ...
        private static readonly MethodInfo multipleMethod = typeof(ReflectionChildrenBinder).GetMethod(nameof(Multiple), BindingFlags.Static | BindingFlags.NonPublic)!;
        private static readonly MethodInfo singleMethod = typeof(ReflectionChildrenBinder).GetMethod(nameof(Single), BindingFlags.Static | BindingFlags.NonPublic)!;
        ...
        private static IChildrenBinder CreateBinder(Type viewType, IBindingProperty childrenProperty)
        {
            var enumerableChildType = childrenProperty.ValueType
                .GetInterfaces()
        ...
        private static ReflectionChildrenBinder<TView, TChildren> Multiple<TView, TChild, TChildren>(IBindingProperty<TChildren> property)
        ...
        private static ReflectionChildrenBinder<TestView, TChild> Single<TView, TChild>(IBindingProperty<TChild?> property)
    ...
    class ReflectionChildrenBinder<TView, TChildren>(Action<TView, TChildren?> setChildren, bool allowsMultiple) : IChildrenBinder
        where TView : IView
    {
