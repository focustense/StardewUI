...
```cs
public class ComponentView<T> : StardewUI.Widgets.DecoratorView<T>
```

### Type Parameters

**`T`**  
Type of view used for the root.


**Inheritance**  
[Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) ⇦ [DecoratorView&lt;T&gt;](decoratorview-1.md) ⇦ ComponentView&lt;T&gt;
...
### Constructors
 ...
 | Name | Description |
| --- | --- |
| [ComponentView&lt;T&gt;()](#componentviewt) | Initializes a new instance of [ComponentView&lt;T&gt;](componentview-1.md). | 
...
| [CreateView()](#createview) | Creates and returns the root view. | 
...
Initializes a new instance of [ComponentView&lt;T&gt;](componentview-1.md).
