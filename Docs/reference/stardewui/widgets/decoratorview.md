...
```cs
public class DecoratorView : StardewUI.Widgets.DecoratorView<T>
```

**Inheritance**  
[Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) ⇦ [DecoratorView&lt;T&gt;](decoratorview-1.md) ⇦ DecoratorView
...
| [View](decoratorview-1.md#view) | The inner view that is decorated by this view.<br><span class="muted" markdown>(Inherited from [DecoratorView&lt;T&gt;](decoratorview-1.md))</span> | 
